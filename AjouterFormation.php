...
<form action="AjouterFormation_uti.php" method="GET">
    <div class="container">
      ...
      <hr>
        ...
        <br>
        <br>
        <label style="color:white;" for="Formation_duree"><b>Durée de la formation</b></label><br>
        <input  type="text" placeholder="Duree en jours " name="dureeForma" required>
        <br>
        <label style="color:white;" for="Formation_duree"><b>Catégorie de la formation</b></label><br>
        <input type="checkbox" name="check_list[]" value="5"><label>Développement</label>
         <input type="checkbox" name="check_list[]" value="6"><label>Réseau</label>
         <script>
